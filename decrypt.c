...
{   sboxm = GenerateSBox();
    ...
    byte input[32] = {0x39, 0x33, 0xb, 0xa9, 0xad, 0x7f, 0x7a, 0x59, 0x6a, 0x49, 0x7b, 0x2f, 0x7b, 0x17, 0xb, 0xef,0x3a, 0x34, 0xb, 0xa9, 0xad, 0x7f, 0x7a, 0x59, 0x6a, 0x49, 0x7b, 0x2f, 0x7b, 0x17, 0xb, 0xef};

    byte*p=cbc_decrypt(input);
    int i;
    for (i = 0; i < ; i++) 
	{
		printf("%x ", p[i]);
